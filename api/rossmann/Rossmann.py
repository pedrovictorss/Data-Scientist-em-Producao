...
class Rossmann(object):
    def __ini__(self):
        self.home_path='C:/Users/pedro/OneDrive/Documentos/CURSOS/Data Scientist em Produção/'
        self.competition_distance_scaler   = pickle.load( open(self.home_path + 'Rossmann/parameter/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load( open(self.home_path + 'Rossmann/parameter/competition_time_month_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load( open(self.home_path + 'Rossmann/parameter/promo_time_week_scaler.pkl', 'rb'))        
        self.year_scaler                   = pickle.load( open(self.home_path + 'Rossmann/parameter/year_scaler.pkl', 'rb'))
        self.store_type_scaler             = pickle.load( open(self.home_path + 'Rossmann/parameter/store_type_scaler.pkl', 'rb'))
